<template>
  <div class="reject flex flex-col gap-8">
    ...
    >
      <Column header="متقاضی" class="w-2/12">
        <template #body="{ data }">
      ...
      <Column header="خدمات دهنده" class="w-2/12">
        <template #body="{ data }">
          <div class="flex gap-3 items-center">
            <Avatar
      ...
      <Column field="status" header="وضعیت " class="w-2/12 trow">
        <template #body="{ data }">
...
export default {
  ...
  data() {
    return {
      ...
      pending: [
        {
          servantAvatar: "https://picsum.photos/seed/picsum/200/300",
          servantName: "نام خدمات دهنده",
          applicantAvatar: "https://picsum.photos/seed/picsum/200/300",
  ...
  mounted() {
    this.operationService.getPairedsPast(
      (data) => {
